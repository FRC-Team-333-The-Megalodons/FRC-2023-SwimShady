...
public class DriveBackMeters extends CommandBase {
  ...
  public DriveBackMeters(Chassis chassis, frc.robot.subsystems.Gyro gyro, double degrees, frc.robot.utils.PIDController driveController, PIDController turnController, boolean encodersReset) {
