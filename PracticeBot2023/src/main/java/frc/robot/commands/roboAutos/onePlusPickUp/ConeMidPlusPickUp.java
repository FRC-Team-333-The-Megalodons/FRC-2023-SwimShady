...
public class ConeMidPlusPickUp extends SequentialCommandGroup {
  ...
  public ConeMidPlusPickUp(Chassis chassis, Gyro gyro, Elevator elevator, IntakeAlternate intake) {
    ...
    driveStraightController = new PIDController(.02, .008, 0, 35, 1, 1, Constants.Values.TICKS_PER_METER*.44);
    resetDriveController = new PIDController(.02, .008, 0, 35, 1, 1, -Constants.Values.TICKS_PER_METER*.44);
