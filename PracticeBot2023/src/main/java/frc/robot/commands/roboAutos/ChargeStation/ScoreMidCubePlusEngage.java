...
public class ScoreMidCubePlusEngage extends SequentialCommandGroup {
  /** Creates a new ScoreHighPlusEngage. */
  public ScoreMidCubePlusEngage(Elevator elevator, IntakeAlternate intake, Chassis chassis, Gyro gyro) {
